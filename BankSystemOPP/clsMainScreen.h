...
{
private:
	enum enMainMenueOptions { eListClients = 1, eAddNewClient = 2, eDeleteCleint = 3, eUpdateClient = 4, eFindClient = 5, eShowTransactionsMenue = 6, eMangeUsers = 7, eLoginRegister = 8, eExit = 9 };
